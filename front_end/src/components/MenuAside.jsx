        ...
        <>
            <div className='d-flex flex-column gap-2'>
                <Link to="/logIn" className='text-secondary' style={{ textDecoration: "none" }}>
                    <a ><i className="bi bi-person-fill"></i>Log in</a>
                </Link>
                <Link to="/signin" className='text-secondary' style={{ textDecoration: "none" }}>
                    <a><i className="bi bi-person-fill-add"></i>Sign In</a>
                </Link>
                <hr />
                <Link to="/" className='text-secondary' style={{ textDecoration: "none" }}>
                    <a><i className="bi bi-info-circle-fill"></i>About Us</a>
                </Link>
                <Link to="/" className='text-secondary' style={{ textDecoration: "none" }}>
                    <a><i className="bi bi-person-lines-fill"></i>Contacts</a>
                </Link>
            </div>
        </>
    )
